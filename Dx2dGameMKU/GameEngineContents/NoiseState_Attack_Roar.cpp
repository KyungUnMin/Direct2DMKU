...
const std::string_view NoiseState_Attack_Roar::AniName = "Attack_Roar";
const std::string_view NoiseState_Attack_Roar::AniFileName = "Noise_Roar.png";
const std::pair<int, int> NoiseState_Attack_Roar::AniCutFrame = std::pair<int, int>(5, 3);
const float NoiseState_Attack_Roar::AniInterTime = 0.08f;
const int NoiseState_Attack_Roar::Damage = 1;

NoiseState_Attack_Roar::NoiseState_Attack_Roar()
{
...
void NoiseState_Attack_Roar::Start()
{
...
void NoiseState_Attack_Roar::LoadAnimation()
{
...
void NoiseState_Attack_Roar::CreateAnimation()
{
...
void NoiseState_Attack_Roar::EnterState()
{
...
void NoiseState_Attack_Roar::Update(float _DeltaTime)
{
...
void NoiseState_Attack_Roar::Attack()
{
	//첫 적중 공격만
	if (true == IsAttackOk)
		return;
...
void NoiseState_Attack_Roar::ExitState()
{
