...
const std::string_view YamadaState_Attack_Tackle::TackleStart_AniFileName = "Yamada_TackleStart.png";
const std::string_view YamadaState_Attack_Tackle::TackleLoop_AniFileName = "Yamada_TackleLoop.png";
const std::pair<int, int> YamadaState_Attack_Tackle::TackleStart_AniCutFrame = std::pair<int, int>(5, 1);
const std::pair<int, int> YamadaState_Attack_Tackle::TackleLoop_AniCutFrame = std::pair<int, int>(5, 2);
const float YamadaState_Attack_Tackle::AniInterTime = 0.08f;
const int YamadaState_Attack_Tackle::Damage = 10;

YamadaState_Attack_Tackle::YamadaState_Attack_Tackle()
{
...
void YamadaState_Attack_Tackle::Start()
{
...
void YamadaState_Attack_Tackle::LoadAnimation()
{
...
void YamadaState_Attack_Tackle::CreateAnimation()
{
...
void YamadaState_Attack_Tackle::EnterState()
{
...
void YamadaState_Attack_Tackle::Update(float _DeltaTime)
{
...
bool YamadaState_Attack_Tackle::TackleMove(float _DeltaTime)
{
...
void YamadaState_Attack_Tackle::CreateCollEffect()
{
...
void YamadaState_Attack_Tackle::Attack()
{
...
void YamadaState_Attack_Tackle::ExitState()
{
