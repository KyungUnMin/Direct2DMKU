...
class NoiseState_Attack_Meteor : public BossState_AttackBase
{
public:
	NoiseState_Attack_Meteor();
	~NoiseState_Attack_Meteor() override;

	NoiseState_Attack_Meteor(const NoiseState_Attack_Meteor& _Other) = delete;
	NoiseState_Attack_Meteor(NoiseState_Attack_Meteor&& _Other) noexcept = delete;
	NoiseState_Attack_Meteor& operator=(const NoiseState_Attack_Meteor& _Other) = delete;
	NoiseState_Attack_Meteor& operator=(const NoiseState_Attack_Meteor&& _Other) noexcept = delete;
