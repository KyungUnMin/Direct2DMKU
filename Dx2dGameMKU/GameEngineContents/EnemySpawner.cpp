...
std::shared_ptr<FieldEnemyBase> EnemySpawner::CreateEnemy(EnemyType _Type, const float4& _CreatePos)
{
	...
	case EnemyType::Waver:
		...
		break;
	case EnemyType::Misuzu:
		EnemyPtr = Level->CreateActor<FieldEnemy_Misuzu>(UpdateOrder::Enemy);
		break;
	case EnemyType::Yamada:
	...
	case EnemyType::Noise:
		...
		break;
	case EnemyType::NoiseFan:
		EnemyPtr = Level->CreateActor<NoiseFan>(UpdateOrder::Enemy);
		break;
	}
