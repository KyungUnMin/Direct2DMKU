...
class YamadaState_Attack_Meteor : public BossState_AttackBase
{
public:
	YamadaState_Attack_Meteor();
	~YamadaState_Attack_Meteor() override;

	YamadaState_Attack_Meteor(const YamadaState_Attack_Meteor& _Other) = delete;
	YamadaState_Attack_Meteor(YamadaState_Attack_Meteor&& _Other) noexcept = delete;
	YamadaState_Attack_Meteor& operator=(const YamadaState_Attack_Meteor& _Other) = delete;
	YamadaState_Attack_Meteor& operator=(const YamadaState_Attack_Meteor&& _Other) noexcept = delete;
